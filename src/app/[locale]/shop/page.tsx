...
import { getCachedProducts, getCachedFilters } from '@/services/productService.cached';
        ...
        <div className="flex-1 min-w-0">
          {products.length > 0 ? (
            <>
              ...
              {pagination && (
                <PaginationLink meta={pagination} className="pt-6" />
              )}
            </>
          ) : (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              {(query.search || query.category || query.minPrice || query.maxPrice) && (
                <Link
                  href={`/${locale}/shop`}
